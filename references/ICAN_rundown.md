# Rundown of Active CAN Messages & Signals (Fully Translated)

This document evaluates `canlog.txt` against `PQ35_46_ICAN.dbc`. All 41 unique CAN IDs in the log were matched to DBC definitions. All signal names, comments, notes, and enum states have been fully translated to English using Google Translate API.
...
| `AB1_HeckCrash` | **AB1_rear_crash** | Bit 1, 1b, Intel | Scale: 1.0 | `0`: no rear crash<br>`1`: Rear crash |
...
| `AB1_Beif_Airbag_deaktiviert` | **AB1_Beif_airbag_deactivated** | Bit 10, 1b, Intel | Scale: 1.0 | `1`: disabled<br>`0`: active |
...
| `AB1_Diagnose` | **AB1_Diagnose** | Bit 16, 1b, Intel | Scale: 1.0 | `0`: not in diagnosis<br>`1`: in diagnosis |
...
| `AB1_KD_Fehler` | **AB1_KD_error**<br>*Note: If the bit is set, at least one customer service error is entered* | Bit 19, 1b, Intel | Scale: 1.0 | `1`: Error memory entry<br>`0`: no error memory entry |
...
| `AB1_Pruefsumme` | **AB1_checksum**<br>*Note: Checksum, definition in the CAN specifications* | Bit 24, 8b, Intel | Scale: 1.0 | - |
...
| German Signal Name | English Translation | Details (Bit/Len/Endian) | Scale/Offset/Unit | Values/States |
|---|---|---|---|---|
| `LS1_Blk_links` | **LS1_turn_signal_left**<br>*Note: Left direction flashing activated (see Gateway Comfort)* | Bit 0, 1b, Intel | Scale: 1.0 | `0`: out of<br>`1`: activated |
| `LS1_Blk_rechts` | **LS1_turn_signal_right**<br>*Note: Right direction flashing activated (see Gateway Comfort)* | Bit 1, 1b, Intel | Scale: 1.0 | `0`: out of<br>`1`: activated |
...
| `LS1_LSY_unten` | **LS1_LSY_below**<br>*Note: Steering column adjustment Y-* | Bit 25, 1b, Intel | Scale: 1.0 | - |
...
| `LS1_ELV_enable` | **LS1_ELV_enable**<br>*Note: Command to lock or unlock the electric steering column lock* | Bit 28, 1b, Intel | Scale: 1.0 | `0`: Unlock ELV<br>`1`: Lock ELV |
| `LS1_def_ELV_Enable` | **LS1_def_ELV_Enable** | Bit 29, 1b, Intel | Scale: 1.0 | `0`: ELV Enable OK<br>`1`: ELV Enable defective |
...
| `LS1_MFL_vorhanden` | **LS1_MFL_available**<br>*Note: 1 = Multifunction steering wheel available* | Bit 33, 1b, Intel | Scale: 1.0 | - |
...
| `LS1_Fehler_Vibration` | **LS1_Vibration_error**<br>*Note: Vibration steering wheel error* | Bit 42, 1b, Intel | Scale: 1.0 | `0`: no error<br>`1`: Mistake |
...
| German Signal Name | English Translation | Details (Bit/Len/Endian) | Scale/Offset/Unit | Values/States |
|---|---|---|---|---|
| `ZS1_ZAS_Kl_S` | **ZS1_Ignition_starter_switch_terminal_S** | Bit 0, 1b, Intel | Scale: 1.0 | - |
...
| German Signal Name | English Translation | Details (Bit/Len/Endian) | Scale/Offset/Unit | Values/States |
|---|---|---|---|---|
| `GWB_Alt_FzgGeschw` | **GWB Obsolete vehicle speed** | Bit 0, 1b, Intel | Scale: 1.0 | `1`: outdated<br>`0`: currently received |
| `GWB_Alt_2_Bremse` | **GWB Obsolete 2 brake** | Bit 1, 1b, Intel | Scale: 1.0 | `1`: outdated<br>`0`: currently received |
| `GWB_Alt_1_Bremse` | **GWB Obsolete 1 brake** | Bit 2, 1b, Intel | Scale: 1.0 | `1`: outdated<br>`0`: currently received |
| `GWB_Alt_1_Getriebe` | **GWB Obsolete 1 gearbox** | Bit 3, 1b, Intel | Scale: 1.0 | `1`: outdated<br>`0`: currently received |
| `GWB_Alt_2_Getriebe` | **GWB Obsolete 2 gearboxes** | Bit 4, 1b, Intel | Scale: 1.0 | `1`: outdated<br>`0`: currently received |
| `GWB_Alt_1_EPB` | **GWB Obsolete 1 EPB** | Bit 5, 1b, Intel | Scale: 1.0 | `1`: outdated<br>`0`: currently received |
| `GWB_Alt_5_Bremse` | **GWB Obsolete 5 brake** | Bit 6, 1b, Intel | Scale: 1.0 | `1`: outdated<br>`0`: currently received |
| `GWB_Alt_AWV_X` | **GWB Obsolete AWV X** | Bit 7, 1b, Intel | Scale: 1.0 | `1`: outdated<br>`0`: currently received |
| `GWB_FzgGeschw_Quelle` | **GWB vehicle speed source** | Bit 8, 1b, Intel | Scale: 1.0 | `1`: ABS<br>`0`: no ABS |
...
| `GWB_Wegimpuls_Status` | **GWB path impulse status** | Bit 35, 1b, Intel | Scale: 1.0 | `0`: Reset and no overflow<br>`1`: at least 1 overflow |
| `GWB_Wegimpulse_Fehler` | **GWB path pulses error** | Bit 39, 1b, Intel | Scale: 1.0 | `0`: Distance pulses OK<br>`1`: Mistake |
| `GWB_Impulszahl` | **GWB pulse number** | Bit 40, 6b, Intel | Scale: 1.0 | - |
| `GWB_Alt_PLA_Status` | **GWB Obsolete PLA status** | Bit 46, 1b, Intel | Scale: 1.0 | `1`: outdated<br>`0`: currently received |
...
| `GWB_Notbremsung` | **GWB_Notbremsung** | Bit 49, 1b, Intel | Scale: 1.0 | `0`: no emergency braking<br>`1`: Emergency braking detected |
...
| `GWB_ESP_Eingriff` | **GWB ESP intervention** | Bit 58, 1b, Intel | Scale: 1.0 | `0`: no ESP intervention<br>`1`: ESP intervention |
| `GWB_Shift_Lock` | **GWB Shift Lock** | Bit 59, 1b, Intel | Scale: 1.0 | `1`: lamp on<br>`0`: Lamp off |
| `GWB_Info_Waehlhebel` | **GWB info selector lever** | Bit 60, 4b, Intel | Scale: 1.0 | `12`: Pos S Automatic Sport<br>`6`: Item N<br>`7`: Pos R<br>`3`: Pos 3<br>`4`: Item 4<br>`1`: Item 1<br>`2`: Pos 2<br>`5`: Pos D Automatic<br>`13`: Pos L<br>`10`: Item Z1<br>`9`: Pos RSP Manual Sport<br>`0`: Zwischenstellung<br>`8`: Pos P Key Lock Release<br>`14`: Tip Alley Manual<br>`11`: Pos Z2<br>`15`: Mistake |
...
| German Signal Name | English Translation | Details (Bit/Len/Endian) | Scale/Offset/Unit | Values/States |
|---|---|---|---|---|
| `GWM_Alt_1_Motor` | **GWM Obsolete 1 engine** | Bit 0, 1b, Intel | Scale: 1.0 | `1`: outdated<br>`0`: currently received |
| `GWM_Alt_2_Motor` | **GWM Obsolete 2 engine** | Bit 1, 1b, Intel | Scale: 1.0 | `1`: outdated<br>`0`: currently received |
| `GWM_Alt_5_Motor` | **GWM Obsolete 5 engine**<br>*Note: outdated signals from message motor 5* | Bit 2, 1b, Intel | Scale: 1.0 | `1`: outdated<br>`0`: currently received |
| `GWM_Alt_Motor_Bremse` | **GWM Outdated Motor Brake** | Bit 3, 1b, Intel | Scale: 1.0 | `1`: outdated<br>`0`: currently received |
...
| `GWM_Bremslicht_Schalter` | **GWM brake light switch**<br>*Note: Unfiltered raw signal (vehicle without BLS (e.g. Touareg GP): see 'Specification interface and behavior during driver braking for engine control unit and brake control unit in the Touareg GP', author M. Williges)* | Bit 32, 1b, Intel | Scale: 1.0 | `1`: Brake applied<br>`0`: no braking |
| `GWM_Bremstest_Schalter` | **GWM brake test switch** | Bit 33, 1b, Intel | Scale: 1.0 | `0`: no braking<br>`1`: Brake applied |
...
| `GWM_Kennfeldkuehlung` | **GWM map cooling**<br>*Note: The map cooling is installed in this vehicle and has no system errors* | Bit 38, 1b, Intel | Scale: 1.0 | `1`: Yes<br>`0`: no |
| `GWM_Komp_Leist_red` | **GWM Comp Power red**<br>*Note: Air conditioning compressor power reduction (currently not used in the PQ35/46)* | Bit 39, 1b, Intel | Scale: 1.0 | `1`: Yes<br>`0`: no |
...
| `RA1_DSP_Zeichen_8` | **RA1_DSP_sign_8**<br>*Note: Display data 8. Character line 1* | Bit 56, 8b, Intel | Scale: 1.0 | - |
...
| German Signal Name | English Translation | Details (Bit/Len/Endian) | Scale/Offset/Unit | Values/States |
|---|---|---|---|---|
| `RA2_DSP_Zeichen_9` | **RA2_DSP_sign_9** | Bit 0, 8b, Intel | Scale: 1.0 | - |
| `RA2_DSP_Zeichen_10` | **RA2_DSP_sign_10** | Bit 8, 8b, Intel | Scale: 1.0 | - |
| `RA2_DSP_Zeichen_11` | **RA2_DSP_sign_11** | Bit 16, 8b, Intel | Scale: 1.0 | - |
...
| German Signal Name | English Translation | Details (Bit/Len/Endian) | Scale/Offset/Unit | Values/States |
|---|---|---|---|---|
| `LW1_Lenkradwinkel` | **LW1_steering_wheel_angle** | Bit 0, 15b, Intel | Scale: 0.04375, Unit: 'Unit_DegreOfArc' | - |
...
| `LW1_Int_Status` | **LW1_Int_Status** | Bit 41, 2b, Intel | Scale: 1.0 | `2`: sporadic error<br>`3`: permanent error<br>`1`: no init<br>`0`: OK |
| `LW1_KL30_Ausfall` | **LW1_KL30_failure** | Bit 43, 1b, Intel | Scale: 1.0 | `0`: OK<br>`1`: no init s |
| `LW1_Zaehler` | **LW1_counter**<br>*Note: free-running message counter* | Bit 44, 4b, Intel | Scale: 1.0 | - |
...
| German Signal Name | English Translation | Details (Bit/Len/Endian) | Scale/Offset/Unit | Values/States |
|---|---|---|---|---|
| `CL1_Drehzahlanhebung` | **CL1_speed_increase** | Bit 0, 1b, Intel | Scale: 1.0 | `1`: elevation<br>`0`: no increase |
| `CL1_Zuheizer` | **CL1_auxiliary_heater** | Bit 1, 1b, Intel | Scale: 1.0 | `1`: A<br>`0`: Out of |
...
| `CL1_Kompressor` | **CL1_compressor**<br>*Note: 1 = compressor on, status including 140ms precontrol, information to the MSG: compressor ON, PQ34 long: request to the MSG: switch on the compressor* | Bit 4, 1b, Intel | Scale: 1.0 | `1`: A<br>`0`: Out of |
| `CL1_Heizung_aus` | **CL1_heating_off** | Bit 5, 1b, Intel | Scale: 1.0 | `0`: Heating output<br>`1`: no heating output |
| `CL1_Kompressormoment_alt` | **CL1_Compressor_torque_Obsolete** | Bit 6, 1b, Intel | Scale: 1.0 | `0`: current<br>`1`: outdated |
| `CL1_Kaeltemitteldruck_alt` | **CL1_Refrigerant_Pressure_Obsolete** | Bit 7, 1b, Intel | Scale: 1.0 | `0`: current<br>`1`: outdated |
...
| `CL1_Last_Kompressor` | **CL1_load_compressor** | Bit 24, 8b, Intel | Scale: 0.25, Unit: 'Unit_NewtoMeter' | `255`: Mistake |
| `CL1_Geblaeselast` | **CL1_fan_load**<br>*Note: Load info: fan control* | Bit 32, 8b, Intel | Scale: 0.4, Unit: 'Unit_PerCent' | `255`: Mistake |
...
| `CL1_Restwaerme` | **CL1_residual_heat**<br>*Note: 1 = residual heat function is activated, status information, i.e. fan load is present* | Bit 51, 1b, Intel | Scale: 1.0 | `0`: not activated<br>`1`: activated |
...
| `KL_Thermomanagement` | **Terminal thermal management**<br>*Note: Stufen des Thermomanagements* | Bit 56, 2b, Intel | Scale: 1.0 | `3`: full release TMM<br>`0`: no release TMM<br>`2`: medium release TMM<br>`1`: small release TMM |
...
| `CL2_SitzH_links` | **CL2_seat_H_left** | Bit 24, 3b, Intel | Scale: 1.0 | - |
| `CL2_SitzH_rechts` | **CL2_seat_H_right** | Bit 27, 3b, Intel | Scale: 1.0 | - |
| `CL2_StSt_Info` | **CL2_St_St_Info**<br>*Note: Stop enable/start request for the start-stop coordinator* | Bit 30, 2b, Intel | Scale: 1.0 | `3`: System error<br>`0`: engine running n<br>`1`: Stop prohibition motor start nn<br>`2`: Motor start necessary |
| `CL2_SH` | **CL2_SH**<br>*Note: 1 = auxiliary heater on, 0 = auxiliary heater off* | Bit 32, 1b, Intel | Scale: 1.0 | - |
...
| `NMGW_I_SleepAck` | **NMGW I Sleep Ack**<br>*Note: Bus Sleep Acknowledge* | Bit 13, 1b, Intel | Scale: 1.0 | - |
...
| `NMGW_I_CAN` | **NMGW I CAN**<br>*Note: Wake-up cause: CAN* | Bit 23, 1b, Intel | Scale: 1.0 | - |
...
| `NMGW_I_Info_CAN` | **NMGW I Info CAN**<br>*Note: Wake up via infotainment CAN* | Bit 26, 1b, Intel | Scale: 1.0 | - |
...
| `NWM_RNS_Fkt_WakeUp` | **NWM RNS wake-up function** | Bit 21, 3b, Intel | Scale: 1.0 | `3`: Telephone mute<br>`1`: dimming<br>`2`: Comm Req<br>`0`: P Wake Up |
...
| `NWM_RNS_Ursache_5` | **NWM RNA cause 5** | Bit 28, 1b, Intel | Scale: 1.0 | `1`: TP20_RNA |
...
| `NWM_RNS_Nachlauf_2` | **NWM RNS wake 2** | Bit 33, 1b, Intel | Scale: 1.0 | `1`: dimming |
| `NWM_RNS_Nachlauf_3` | **NWM RNS wake 3** | Bit 34, 1b, Intel | Scale: 1.0 | `1`: Telephone mute |
| `NWM_RNS_Nachlauf_4` | **NWM RNS wake 4**<br>*Note: 1 = internal overrun before wakeup 4* | Bit 35, 1b, Intel | Scale: 1.0 | - |
...
| `NWM_RNS_Nachlauf_8` | **NWM RNS wake 8**<br>*Note: 1 = internal overrun before wakeup 8* | Bit 39, 1b, Intel | Scale: 1.0 | - |
...
| `NWM_RNS_Anf_4` | **NWM RNS Beginn 4** | Bit 51, 1b, Intel | Scale: 1.0 | - |
| `NWM_RNS_Anf_5` | **NWM RNS Beginn 5** | Bit 52, 1b, Intel | Scale: 1.0 | - |
| `NWM_RNS_Anf_6` | **NWM RNS beginning 6** | Bit 53, 1b, Intel | Scale: 1.0 | - |
| `NWM_RNS_Anf_7` | **NWM RNS beginning 7** | Bit 54, 1b, Intel | Scale: 1.0 | - |
...
| `BSK_Blk_rechts` | **BSK indicator right** | Bit 1, 1b, Intel | Scale: 1.0 | `1`: Indicator light indicator R on |
...
| `BSK_DWA_Akku` | **BSK DWA battery**<br>*Note: DWA battery empty indicator light* | Bit 4, 1b, Intel | Scale: 1.0 | `0`: Battery OK<br>`1`: DWA battery empty |
| `BSK_Rueckfahrlicht` | **BSK reversing light**<br>*Note: 1 = reversing light on* | Bit 5, 1b, Intel | Scale: 1.0 | `1`: Reversing light on |
...
| `BSK_MH_geoeffnet` | **BSK MH open** | Bit 12, 1b, Intel | Scale: 1.0 | `0`: Hood closed<br>`1`: Haube_offen |
| `BSK_HD_Hauptraste` | **BSK HD main peg**<br>*Note: Trunk lid main catch status* | Bit 13, 1b, Intel | Scale: 1.0 | `0`: closed<br>`1`: main rest |
| `BSK_HD_Vorraste` | **BSK HD pre-detent**<br>*Note: Boot lid pre-latch status* | Bit 14, 1b, Intel | Scale: 1.0 | `0`: closed<br>`1`: Vorrast |
| `BSK_Unterspannung` | **BSK undervoltage**<br>*Note: Undervoltage, signals no longer all ok.* | Bit 15, 1b, Intel | Scale: 1.0 | `0`: OK<br>`1`: Undervoltage |
| `BSK_Display` | **BSK display** | Bit 16, 7b, Intel | Scale: 1.0, Unit: 'Unit_PerCent' | `127`: Mistake |
| `BSK_Display_def` | **BSK display def** | Bit 23, 1b, Intel | Scale: 1.0 | `0`: Terminal 58d OK<br>`1`: Terminal 58d not OK |
...
| `BSK_Buzzer` | **BSK Buzzer**<br>*Note: In vehicles with separate daytime running lights, the daytime running lights can be activated or deactivated using an operating sequence of left turn signal (deactivate) / right turn signal (activate), headlight flasher on and terminal 15 on. As acknowledgment of this activation/D* | Bit 33, 1b, Intel | Scale: 1.0 | `0`: no gong<br>`1`: Control the gong |
...
| `BSK_Def_Lampe` | **BSK Def lamp** | Bit 36, 1b, Intel | Scale: 1.0 | `0`: OK<br>`1`: defect |
...
| German Signal Name | English Translation | Details (Bit/Len/Endian) | Scale/Offset/Unit | Values/States |
|---|---|---|---|---|
| `GWI_alt_ZKE_4` | **GWI Obsolete ZKE 4**<br>*Note: 1 = Message m ZKE 4 not received (>400 ms)* | Bit 0, 1b, Intel | Scale: 1.0 | `1`: outdated<br>`0`: currently received |
| `GWI_alt_ZKE_3` | **GWI Obsolete ZKE 3** | Bit 1, 1b, Intel | Scale: 1.0 | `1`: outdated<br>`0`: currently received |
| `GWI_alt_Kombi_1` | **GWI Obsolete Combi 1** | Bit 2, 1b, Intel | Scale: 1.0 | `1`: outdated<br>`0`: currently received |
| `GWI_res3` | **GWI res3** | Bit 3, 1b, Intel | Scale: 1.0 | `1`: outdated<br>`0`: currently received |
| `GWI_res4` | **GWI res4** | Bit 4, 1b, Intel | Scale: 1.0 | `1`: outdated<br>`0`: currently received |
| `GWI_res5` | **GWI res5** | Bit 5, 1b, Intel | Scale: 1.0 | `1`: outdated<br>`0`: currently received |
| `GWI_res6` | **GWI res6** | Bit 6, 1b, Intel | Scale: 1.0 | `1`: outdated<br>`0`: currently received |
| `GWI_res7` | **GWI res7** | Bit 7, 1b, Intel | Scale: 1.0 | `1`: outdated<br>`0`: currently received |
...
| `GWI_ZKE4_Zusatzfkt` | **GWI ZKE4 additional function**<br>*Note: Additional functions of the comfort control unit are available if DLC from m ZKE 4 >6* | Bit 15, 1b, Intel | Scale: 1.0 | - |
...
| `LIA_Abblendlicht` | **LIA low beam** | Bit 1, 1b, Intel | Scale: 1.0 | `1`: Kl56b_ein<br>`0`: out of |
...
| `LIA_BLK_Frequenz` | **LIA indicator frequency**<br>*Note: 1 = flashing frequency of the indicators* | Bit 12, 1b, Intel | Scale: 1.0 | `1`: Blink freq on |
...
| `LIA_Kurv_Licht` | **LIA curve light**<br>*Note: Cornering lights are switched on* | Bit 18, 1b, Intel | Scale: 1.0 | `1`: Cornering lights on |
...
| `LIA_Pruefsumme` | **LIA checksum**<br>*Note: Definition according to the specifications* | Bit 24, 8b, Intel | Scale: 1.0 | - |
...
| German Signal Name | English Translation | Details (Bit/Len/Endian) | Scale/Offset/Unit | Values/States |
|---|---|---|---|---|
| `MO7_LL_Status` | **MO7_LL_status** | Bit 0, 1b, Intel | Scale: 1.0 | `1`: LLDZ has reached value 1 level<br>`0`: no need for increased LL DZ |
| `MO7_V_Begrenz` | **MO7_V_limit** | Bit 1, 1b, Intel | Scale: 1.0 | `0`: V Limitation not possible<br>`1`: V Limitation possible |
...
| `MO7_Gradient_Drehz` | **MO7_gradient_speed** | Bit 24, 7b, Intel | Scale: 1.0, Unit: 'Unit_MinutInver' | `127`: is greater than 127 min |
...
| `MO7_Mot_weckfaehig` | **MO7_motor_awakenable** | Bit 44, 1b, Intel | Scale: 1.0 | `1`: Awaken ACAN found<br>`0`: no waking ACAN |
| `MO7_Zus_Kuehl` | **MO7_To_Cool** | Bit 45, 1b, Intel | Scale: 1.0 | `1`: Yes<br>`0`: no |
| `MO7_Sleep_Ind` | **MO7_Sleep_Ind** | Bit 46, 1b, Intel | Scale: 1.0 | `0`: CAN is required<br>`1`: Sleep ready |
| `MO7_Rueck_LLDz` | **MO7_Back_LLDz** | Bit 47, 1b, Intel | Scale: 1.0 | `0`: no need for increased LL DZ<br>`1`: LLDZ has reached value 2 level |
| `MO7_Last_abwurf` | **MO7_load_shedding** | Bit 48, 2b, Intel | Scale: 1.0 | `3`: Stage 3<br>`2`: Stage 2<br>`0`: Level 0<br>`1`: Stage 1 |
| `MO7_Ein_Generator` | **MO7_A_generator** | Bit 50, 1b, Intel | Scale: 1.0 | `1`: Generator on<br>`0`: Generator off |
...
| `MO7_Oeltemperatur` | **MO7_oil_temperature** | Bit 56, 8b, Intel | Scale: 1.0, Offset: -60.0, Unit: 'Unit_DegreCelsi' | `1`: Init<br>`0`: not installed<br>`255`: Mistake |
...
| German Signal Name | English Translation | Details (Bit/Len/Endian) | Scale/Offset/Unit | Values/States |
|---|---|---|---|---|
| `EKD_Motor_A` | **EKD Motor A**<br>*Note: If the bit is set, at least one customer service error is entered* | Bit 0, 1b, Intel | Scale: 1.0 | `1`: Error memory entry<br>`0`: no error memory entry |
| `EKD_Getriebe_A` | **EKD gearbox A** | Bit 1, 1b, Intel | Scale: 1.0 | `1`: Error memory entry<br>`0`: no error memory entry |
| `EKD_Bremse_A` | **EKD brake A**<br>*Note: If the bit is set, at least one customer service error is entered* | Bit 2, 1b, Intel | Scale: 1.0 | `1`: Error memory entry<br>`0`: no error memory entry |
| `EKD_Kombi_A` | **EKD Combi A** | Bit 3, 1b, Intel | Scale: 1.0 | `1`: Error memory entry<br>`0`: no error memory entry |
| `EKD_LSM_A` | **EKD LSM A** | Bit 4, 1b, Intel | Scale: 1.0 | `1`: Error memory entry<br>`0`: no error memory entry |
...
| `EKD_Niveau_A` | **EKD level A** | Bit 8, 1b, Intel | Scale: 1.0 | `1`: Error memory entry<br>`0`: no error memory entry |
...
| `EKD_PLA_A` | **EKD PLA A**<br>*Note: at least one error is entered in the customer service error memory* | Bit 20, 1b, Intel | Scale: 1.0 | `1`: Error memory entry<br>`0`: no error memory entry |
...
| `EKD_Memory_K` | **EKD Memory K**<br>*Note: 1 = at least 1 customer service error is entered in the control unit* | Bit 30, 1b, Intel | Scale: 1.0 | `1`: Error memory entry<br>`0`: no error memory entry |
| `EKD_Dachmodul_K` | **EKD roof module K** | Bit 31, 1b, Intel | Scale: 1.0 | `1`: Error memory entry<br>`0`: no error memory entry |
| `EKD_Zentralelektrik_II_K` | **EKD Central Electrics II K**<br>*Note: Customer service error in central electrics 2 on CAN comfort* | Bit 32, 1b, Intel | Scale: 1.0 | `1`: Error memory entry<br>`0`: no error memory entry |
...
| `EKD_PTC_Heizung_K` | **EKD PTC Heater K**<br>*Note: 1 = at least 1 error entered in the customer service error memory* | Bit 38, 1b, Intel | Scale: 1.0 | `1`: Error memory entry<br>`0`: no error memory entry |
...
| `EKD_MDI_I` | **EKD MDI I**<br>*Note: Error entry exists* | Bit 43, 1b, Intel | Scale: 1.0 | `1`: Error memory entry<br>`0`: no error memory entry |
...
| `EKD_Easy_Entry_VB` | **EKD Easy Entry VB**<br>*Note: 1 = at least 1 customer service error is entered in the control unit (static or sporadic)* | Bit 47, 1b, Intel | Scale: 1.0 | `1`: Error memory entry<br>`0`: no error memory entry |
...
| `EKD_Sonderfahrzeug_SG_K` | **EKD special vehicle SG K**<br>*Note: 1 = at least 1 customer service error entry in the control unit* | Bit 50, 1b, Intel | Scale: 1.0 | `1`: Error memory entry<br>`0`: no error memory entry |
| `EKD_Tastenmodul_I` | **EKD button module I**<br>*Note: Error entry exists* | Bit 51, 1b, Intel | Scale: 1.0 | `1`: Error memory entry<br>`0`: no error memory entry |
...
| `EKD_WFS_K` | **EKD WFS K** | Bit 53, 1b, Intel | Scale: 1.0 | `1`: Error memory entry<br>`0`: no error memory entry |
| `EKD_GSM_Pager_I` | **EKD GSM Pager I**<br>*Note: Error entry exists* | Bit 54, 1b, Intel | Scale: 1.0 | `1`: Error memory entry<br>`0`: no error memory entry |
...
| `EKD_DAB_I` | **EKD DAB I**<br>*Note: Error entry exists* | Bit 57, 1b, Intel | Scale: 1.0 | `1`: Error memory entry<br>`0`: no error memory entry |
| `EKD_Telematik_I` | **EKD Telematics I**<br>*Note: Error entry exists* | Bit 58, 1b, Intel | Scale: 1.0 | `1`: Error memory entry<br>`0`: no error memory entry |
| `EKD_Navigation_I` | **EKD Navigation I**<br>*Note: Error entry exists* | Bit 59, 1b, Intel | Scale: 1.0 | `1`: Error memory entry<br>`0`: no error memory entry |
| `EKD_TV_Tuner_I` | **EKD TV Tuner I**<br>*Note: 1 = at least 1 error entered in the customer service error memory* | Bit 60, 1b, Intel | Scale: 1.0 | `1`: Error memory entry<br>`0`: no error memory entry |
...
| `EKD_Radio_I` | **EKD Radio I**<br>*Note: Error entry exists* | Bit 62, 1b, Intel | Scale: 1.0 | `1`: Error memory entry<br>`0`: no error memory entry |
...
| `BS2_Klimaanlage_aus` | **BS2_air_conditioning_off** | Bit 15, 1b, Intel | Scale: 1.0 | `1`: Switch off consumers<br>`0`: Basic state |
...
| `BS2_Warn_Steckdosen` | **BS2_warning_sockets**<br>*Note: 1 = Sockets will be switched off shortly* | Bit 40, 1b, Intel | Scale: 1.0 | - |
...
| `BS2_Warn_Zusatz` | **BS2_Warn_Addition**<br>*Note: 1 = Additional consumers will be switched off shortly* | Bit 42, 1b, Intel | Scale: 1.0 | - |
| `BS2_Weckursache_ACAN` | **BS2_wake-up_cause_ACAN** | Bit 43, 2b, Intel | Scale: 1.0 | `0`: no EKP advance<br>`2`: Alarm cause St Hzg<br>`3`: Door contact alarm cause |
...
| `BS3_Klemme_15` | **BS3_terminal_15**<br>*Note: 1 = Klemme 15 Innenraum ist eingeschaltet* | Bit 1, 1b, Intel | Scale: 1.0 | `0`: Basic state<br>`1`: Terminal 15 active |
...
| `BS3_Klemme_P` | **BS3_terminal_P**<br>*Note: 1 = Terminal P on (parking light)* | Bit 4, 1b, Intel | Scale: 1.0 | `0`: Basic state<br>`1`: Terminal P active |
...
| `BS3_Drehzahlanhebung` | **BS3_speed_increase**<br>*Note: 1 = Request for speed increase (with only one level) or increase to 1st level (see drive BSG load)* | Bit 8, 1b, Intel | Scale: 1.0 | `0`: Basic state<br>`1`: Speed ​​increase level 1 required |
...
| `BS3_Starterbatt` | **BS3_starter_battery**<br>*Note: Shows the status of the starter battery (00=OK, 01=critical, 10=discharged, 11=error)* | Bit 11, 2b, Intel | Scale: 1.0 | `1`: critical<br>`2`: discharged<br>`0`: OK<br>`3`: Mistake |
...
| `BS3_Haubenkontakt` | **BS3_hood_contact** | Bit 15, 1b, Intel | Scale: 1.0 | `0`: Hood closed<br>`1`: Haube_offen |
| `BS3_Coming_Home` | **BS3_Coming_Home**<br>*Note: 1 = Coming Home function activated* | Bit 16, 1b, Intel | Scale: 1.0 | - |
| `BS3_Leaving_Home` | **BS3_Leaving_Home**<br>*Note: 1 = Leaving Home function activated* | Bit 17, 1b, Intel | Scale: 1.0 | - |
| `BS3_K_Luefter_ein` | **BS3_K_fan_on** | Bit 18, 1b, Intel | Scale: 1.0 | `0`: no requirement<br>`1`: turn on |
...
| `BS3_Verglasung_zu` | **BS3_glazing_too**<br>*Note: Command to close the glazing in the window, e.g. when rain is detected and the window/pane roof is open* | Bit 21, 1b, Intel | Scale: 1.0 | `0`: No action<br>`1`: Close glazing |
...
| `BS3_VB_Coming_Home` | **BS3_VB_Coming_Home**<br>*Note: 1 = Coming Home function available in the SG* | Bit 24, 1b, Intel | Scale: 1.0 | - |
| `BS3_VB_Tagesfahrlicht` | **BS3_VB_daytime_running_lights**<br>*Note: 1 = Daytime running lights present in the SG* | Bit 25, 1b, Intel | Scale: 1.0 | - |
| `BS3_VB_Fussraumleuchten` | **BS3_VB_footwell_lights**<br>*Note: 1 = Dimming of footwell lights implemented* | Bit 26, 1b, Intel | Scale: 1.0 | - |
| `BS3_LED_Heckscheibe` | **BS3_LED_rear_window**<br>*Note: 1 = Heated rear window activated* | Bit 27, 1b, Intel | Scale: 1.0 | - |
| `BS3_LED_Frontscheibe` | **BS3_LED_windshield**<br>*Note: 1 = Heated windshield activated* | Bit 28, 1b, Intel | Scale: 1.0 | - |
...
| German Signal Name | English Translation | Details (Bit/Len/Endian) | Scale/Offset/Unit | Values/States |
|---|---|---|---|---|
| `M10_Anzeige` | **M10_display** | Bit 0, 4b, Intel | Scale: 1.0 | `2`: System error start stop<br>`12`: Engine starts<br>`13`: Clutch activated<br>`0`: no display<br>`1`: Start Stop active<br>`15`: Apply the brake<br>`14`: WH to P N<br>`3`: Start the engine manually<br>`5`: Engine running required<br>`9`: Unwanted engine shutdown |
...
| `M10_UDruckDyn` | **M10_U_pressure_dyn** | Bit 7, 1b, Intel | Scale: 1.0 | `1`: Dyn is always smaller than 50mbar<br>`0`: Dyn 1 times larger 50mbar |
...
| `M10_MotorStopp` | **M10_engine_stop** | Bit 10, 1b, Intel | Scale: 1.0 | `0`: Motor stop inactive<br>`1`: Motor stop active |
...
| `M10_Schubabschaltung` | **M10_fuel_cut-off** | Bit 12, 1b, Intel | Scale: 1.0 | `0`: no thrust barriers<br>`1`: Fuel cutoff |
| `M10_Druck_err_gem` | **M10_pressure_err_acc** | Bit 13, 1b, Intel | Scale: 1.0 | `1`: measured<br>`0`: calculated |
| `M10_Freigabe_Reku` | **M10_Release_Recu** | Bit 14, 2b, Intel | Scale: 1.0 | `3`: Reku mode active<br>`0`: RekuModus_aus<br>`2`: Rec. U reduction<br>`1`: Rec. U increase |
...
| `M10_Fahrbereitschaft` | **M10_ready_to_drive** | Bit 22, 1b, Intel | Scale: 1.0 | `0`: not ready to drive<br>`1`: ready to drive |
| `M10_Hybrid` | **M10_hybrid** | Bit 23, 1b, Intel | Scale: 1.0 | `0`: not a hybrid<br>`1`: Hybrid |
| `M10_EM_aktiv` | **M10_EM_active** | Bit 24, 1b, Intel | Scale: 1.0 | `0`: EM inactive<br>`1`: EM active |
...
| `M10_KompAusCode` | **M10_Comp_Off_Code** | Bit 40, 4b, Intel | Scale: 1.0 | `4`: Mot Management 12<br>`2`: Low pressure 3<br>`3`: Outside temp 8<br>`1`: High pressure 1<br>`6`: About 13<br>`0`: no<br>`7`: Undervoltage 10<br>`5`: HD sensor def 17 |
| `M10_StartStopp_Fahrerwunsch` | **M10_Start_Stop_driver_request**<br>*Note: Driver activity start/stop* | Bit 44, 2b, Intel | Scale: 1.0 | `0`: Init<br>`1`: Stopping prohibited by driver<br>`3`: Stop request by driver<br>`2`: Stop release by driver |
| `M10_Akustik` | **M10_acoustics** | Bit 46, 2b, Intel | Scale: 1.0 | `2`: Acoustics 2<br>`3`: free<br>`0`: no acoustics<br>`1`: Acoustics 1 |
...
| `M10_VentilationReq` | **M10_Ventilation_Req**<br>*Note: BMS requests Climatronic to open the recirculation air flap. Signal is mirrored by the MSG from Hybrid-CAN to the A-CAN (m BMS HYB 6, Byte 8, Bit 1 from Hybrid-CAN DF > V1.5)* | Bit 59, 1b, Intel | Scale: 1.0 | `1`: Open the recirculation flap<br>`0`: Do not open the recirculation flap |
...
| `B10_Fahrtr_VL` | **B10_Driver_VL**<br>*Note: Direction detection front wheel left* | Bit 60, 1b, Intel | Scale: 1.0 | `1`: Backward<br>`0`: Forward |
| `B10_Fahrtr_VR` | **B10_driver_VR**<br>*Note: Direction detection front wheel right* | Bit 61, 1b, Intel | Scale: 1.0 | `1`: Backward<br>`0`: Forward |
...
| German Signal Name | English Translation | Details (Bit/Len/Endian) | Scale/Offset/Unit | Values/States |
|---|---|---|---|---|
| `ML1_Ziel_` | **ML1_target** | Bit 0, 8b, Intel | Scale: 1.0 | - |
...
| `NV1_NAV_Error_flag` | **NV1_NAV_Error_flag**<br>*Note: Error entry exists* | Bit 7, 1b, Intel | Scale: 1.0 | `1`: Error memory entry<br>`0`: no error memory entry |
...
| `EH1_Einh_Verbr` | **EH1_unit_consumption** | Bit 3, 1b, Intel | Scale: 1.0 | `0`: Route Vol<br>`1`: Vol route |
| `EH1_Einh_Druck` | **EH1_unit_pressure** | Bit 4, 2b, Intel | Scale: 1.0 | `0`: bear<br>`3`: k Pa<br>`1`: psi<br>`2`: nn |
| `EH1_Datum_Anzeige` | **EH1_date_display**<br>*Note: Date display format (European = 0, American = 1)* | Bit 6, 1b, Intel | Scale: 1.0 | `0`: DD MM YYYY<br>`1`: MM DD YYYY |
...
| `EH1_Verstellung_Strck` | **EH1_adjustment_Strck** | Bit 15, 1b, Intel | Scale: 1.0 | `1`: Yes<br>`0`: no |
...
| `KO1_Freigabe_Zuheizer` | **KO1_enable_auxiliary_heater** | Bit 38, 1b, Intel | Scale: 1.0 | `0`: Additional heater ON<br>`1`: Additional heater OFF |
...
| German Signal Name | English Translation | Details (Bit/Len/Endian) | Scale/Offset/Unit | Values/States |
|---|---|---|---|---|
| `KO2_DCF` | **KO2_DCF**<br>*Note: 1 = DCF signal present* | Bit 0, 1b, Intel | Scale: 1.0 | - |
...
| `KO2_Sekunde` | **KO2_second** | Bit 24, 8b, Intel | Scale: 1.0 | - |
| `KO2_Tag` | **KO2_day** | Bit 32, 8b, Intel | Scale: 1.0 | - |
| `KO2_Monat` | **KO2_month** | Bit 40, 8b, Intel | Scale: 1.0 | - |
...
| `DI1_Display_def` | **DI1_display_def** | Bit 7, 1b, Intel | Scale: 1.0 | `0`: Terminal 58d OK<br>`1`: Terminal 58d not OK |
...
| `SY1_Sleep_Infotainment` | **SY1_Sleep_Infotainment**<br>*Note: CAN infotainment network is sleeping* | Bit 4, 1b, Intel | Scale: 1.0 | `1`: Bus rest<br>`0`: no bus rest |
...
| `SY1_Marke` | **SY1_brand** | Bit 12, 4b, Intel | Scale: 1.0 | `6`: Lamborghini<br>`5`: Bugatti<br>`3`: SK Skoda<br>`0`: VW Volkswagen<br>`7`: Bentley<br>`8`: Rolls-Royce<br>`14`: ford<br>`1`: AU Audi<br>`2`: SE Seat<br>`15`: Porsche<br>`4`: VN VW commercial vehicle |
...
| `SY1_Erweiterung` | **SY1_extension**<br>*Note: Currently not supported in the PQ35/46: 15d for 'not known' is issued* | Bit 24, 4b, Intel | Scale: 1.0 | `5`: open structures<br>`15`: not known<br>`8`: High roof<br>`2`: modified front rear<br>`7`: Flat roof<br>`9`: Other<br>`6`: closed structures<br>`4`: High motorization<br>`3`: Syncro<br>`0`: short wheelbase<br>`1`: long wheelbase |
| `SY1_Rechtslenker` | **SY1_right-hand_drive** | Bit 28, 1b, Intel | Scale: 1.0 | `0`: Left-hand drive<br>`1`: Right-hand drive |
| `SY1_Viertuerer` | **SY1_four-door** | Bit 29, 1b, Intel | Scale: 1.0 | `1`: Four doors or more<br>`0`: Smaller four doors |
| `SY1_Transportmode` | **SY1_transport_mode**<br>*Note: 1 = transport mode active, functional restrictions or changes for vehicle transport* | Bit 30, 1b, Intel | Scale: 1.0 | `0`: not active<br>`1`: active |
...
| `SY1_VersHighCAN_Komfort` | **SY1_Vers_High_CAN_comfort** | Bit 36, 4b, Intel | Scale: 1.0 | - |
| `SY1_VersLowCAN_Antrieb` | **SY1_Vers_Low_CAN_drive** | Bit 40, 4b, Intel | Scale: 1.0 | - |
...
| `SY1_NWDF_gueltig` | **SY1_NWDF_valid**<br>*Note: Validity of network diagnostics enable (byte 7, bit 7)* | Bit 54, 1b, Intel | Scale: 1.0 | `1`: NWDF function supported<br>`0`: NWDF function not supported |
...
| `SY1_Notbrems_Status` | **SY1_emergency_brake_status** | Bit 56, 1b, Intel | Scale: 1.0 | `0`: no emergency braking<br>`1`: Emergency braking situation |
...
| German Signal Name | English Translation | Details (Bit/Len/Endian) | Scale/Offset/Unit | Values/States |
|---|---|---|---|---|
| `GW3_Laendervariante` | **GW3_country_variant** | Bit 0, 6b, Intel | Scale: 1.0 | `6`: Saudi Arabia<br>`5`: Japan<br>`0`: Germany<br>`7`: Australia<br>`3`: Canada<br>`1`: Europe<br>`2`: USA<br>`4`: Great Britain |
| `GW3_Alt_3_Kombi` | **GW3_Obsolete_3_station_wagon** | Bit 6, 1b, Intel | Scale: 1.0 | `1`: outdated<br>`0`: currently received |
...
| `GW3_Sprachvariante` | **GW3_language_variant** | Bit 8, 8b, Intel | Scale: 1.0 | `4`: Italian<br>`0`: no language variant<br>`6`: Portuguese<br>`11`: Dutch<br>`10`: US English<br>`9`: Chinese<br>`1`: German<br>`5`: Spanish<br>`2`: English<br>`12`: Japanese<br>`13`: Russian<br>`15`: French Canadian<br>`14`: Korean<br>`8`: Czech<br>`3`: French<br>`16`: Swedish<br>`18`: Turkish<br>`17`: Polish |
| `GW3_Motortyp` | **GW3_engine_type** | Bit 16, 6b, Intel | Scale: 1.0 | - |
| `GW3_Alt_5_Motor` | **GW3_Obsolete_5_engine**<br>*Note: outdated signals from message motor 5* | Bit 22, 1b, Intel | Scale: 1.0 | `1`: outdated<br>`0`: currently received |
...
| `VBN_dyn_LWR_A` | **VBN dyn LWR A**<br>*Note: Dynamic headlight range control / AFS* | Bit 7, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_Niveau_A` | **VBN level A**<br>*Note: Level control on the CAN drive* | Bit 8, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_Allrad_A` | **VBN all-wheel drive A** | Bit 9, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_ADR_Sensor_A` | **VBN ADR Sensor A**<br>*Note: Target installation of ADR control unit* | Bit 10, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_ADR_getrennt` | **VBN ADR separated** | Bit 11, 1b, Intel | Scale: 1.0 | `1`: ADR separate<br>`0`: ADR connected |
| `VBN_Parkbremse_A` | **VBN parking brake A**<br>*Note: Parking brake on the CAN drive or brake SUB-CAN* | Bit 12, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_EZS_A` | **VBN EZS A**<br>*Note: EZS control unit* | Bit 13, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_Daempfer_A` | **VBN damper A**<br>*Note: Damper SG on the CAN drive* | Bit 14, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_Quersperre` | **VBN cross barrier**<br>*Note: Cross lock in the CAN drive network* | Bit 15, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_Motor_Slave_A` | **VBN Motor Slave A**<br>*Note: Motor slave in the CAN drive network* | Bit 16, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_SWA_A` | **VBN SWA A**<br>*Note: SWA lane change assistant* | Bit 17, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_LDW_A` | **VBN LDW A**<br>*Note: LDW / Heading Control on the drive train* | Bit 18, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
...
| `VBN_TSG_FT_K` | **VBN TSG FT K**<br>*Note: Target installation TSG FT* | Bit 26, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_TSG_BT_K` | **VBN TSG BT K**<br>*Note: Target installation TSG BT* | Bit 27, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_TSG_HL_K` | **VBN TSG HL K**<br>*Note: Target installation TSG HL* | Bit 28, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_TSG_HR_K` | **VBN TSG HR K**<br>*Note: Target installation TSG HR* | Bit 29, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_Memory_K` | **VBN Memory K**<br>*Note: Target installation memory* | Bit 30, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_Dachmodul_K` | **VBN roof module K** | Bit 31, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_Zentralelektrik_II_K` | **VBN central electrics II K**<br>*Note: Target installation of central electrics 2 on the CAN comfort* | Bit 32, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_RDK_K` | **VBN RDK K**<br>*Note: Target tire pressure* | Bit 33, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_SMLS_K` | **VBN SMLS K**<br>*Note: Target installation of steering column module/multifunction steering wheel* | Bit 34, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_Gateway_K` | **VBN Gateway K**<br>*Note: Target installation of gateway module on the CAN comfort* | Bit 35, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_Clima_K` | **VBN Clima K**<br>*Note: Target installation of climate control on the CAN comfort* | Bit 36, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_APS_K` | **VBN APS K**<br>*Note: Sollverbau Einparkhilfe* | Bit 37, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_PTC_Heizung_K` | **VBN PTC Heater K**<br>*Note: 1 = PTC heater installed* | Bit 38, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_Standhzg_K` | **VBN Standhzg K**<br>*Note: Target installation, auxiliary heating on comfort or infotainment* | Bit 39, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_VSG_K` | **VBN VSG K**<br>*Note: Target installation of convertible top control unit* | Bit 40, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_RSE_I` | **VBN RSE I**<br>*Note: Target installation of rear seat entertainment* | Bit 41, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_Wischer_K` | **VBN wiper K** | Bit 42, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_MDI_I` | **VBN MDI I**<br>*Note: Target mobile device interface* | Bit 43, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_AAG_K` | **VBN AAG K**<br>*Note: Target installation of trailer module* | Bit 44, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_Mem_BF_K` | **VBN Mem Passenger K**<br>*Note: Target installation of passenger seat memory* | Bit 45, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_Easy_Entry_VF` | **VBN Easy Entry VF**<br>*Note: Target installation for Easy Entry driver* | Bit 46, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_Easy_Entry_VB` | **VBN Easy Entry VB**<br>*Note: Easy entry passenger* | Bit 47, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_Heckdeckel_K` | **VBN trunk lid K**<br>*Note: Installing the trunk lid control unit* | Bit 48, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_Rearview_I` | **VBN Rearview I**<br>*Note: Target installation, rear view on the infotainment* | Bit 49, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_Sonderfahrzeug_SG_K` | **VBN special vehicle SG K**<br>*Note: Special vehicle SG* | Bit 50, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_Tastenmodul_I` | **VBN key module I**<br>*Note: Target installation of a 10-key keyboard on the CAN infotainment* | Bit 51, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_Kompass_I` | **VBN Compass I**<br>*Note: Target installation of compass on CAN infotainment* | Bit 52, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_WFS_K` | **VBN WFS K**<br>*Note: 1 = Wegfahrsperre am CAN-Komfort verbaut* | Bit 53, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_GSM_Pager_I` | **VBN GSM Pager I**<br>*Note: Target installation of GSM pager on CAN infotainment* | Bit 54, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_InfoElektronik` | **VBN Info Electronics**<br>*Note: Target installation of infotainment cockpit on CAN comfort* | Bit 55, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_DSP_I` | **VBN DSP I**<br>*Note: Target installation of DSP on the CAN infotainment* | Bit 56, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_DAB_I` | **VBN DAB I**<br>*Note: Should also be installed for SDARS tuners* | Bit 57, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_Telematik_I` | **VBN Telematics I**<br>*Note: Target installation of telematics on the CAN infotainment* | Bit 58, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_Navigation_I` | **VBN Navigation I** | Bit 59, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_TV_Tuner_I` | **VBN TV Tuner I**<br>*Note: Target installation of TV tuner on CAN infotainment* | Bit 60, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_Neigungsmodul_I` | **VBN inclination module I**<br>*Note: Target installation of tilt module on CAN infotainment* | Bit 61, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_Radio_I` | **VBN Radio I** | Bit 62, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
| `VBN_Telefon_I` | **VBN Telephone I**<br>*Note: Target installation of telephone on CAN infotainment* | Bit 63, 1b, Intel | Scale: 1.0 | `0`: no target construction<br>`1`: Target installation |
...
| `BEM_Ladezustand` | **BEM charging status**<br>*Note: Display of the SOC in bar graph* | Bit 24, 4b, Intel | Scale: 10.0, Unit: 'Unit_PerCent' | `14`: Init<br>`15`: Mistake |
...
| `BEM_REK_aktiv` | **BEM REK active** | Bit 37, 1b, Intel | Scale: 1.0 | `0`: no recu release<br>`1`: Reku release |
| `BEM_EMLIN_ungueltig` | **BEM EMLIN invalid** | Bit 38, 1b, Intel | Scale: 1.0 | `0`: Signals valid<br>`1`: Signals invalid |
| `BEM_Batt_Ab` | **BEM Batt Ab** | Bit 39, 1b, Intel | Scale: 1.0 | `0`: tied together<br>`1`: not connected |
| `BEM_UBDM` | **BEM UBDM**<br>*Note: Battery voltage measured by the battery data module* | Bit 40, 8b, Intel | Scale: 0.05, Offset: 5.0, Unit: 'Unit_Volt' | - |
...
| `DN1_Stunde` | **DN1_hour**<br>*Note: 18h - 1 Fh invalid* | Bit 44, 5b, Intel | Scale: 1.0, Unit: 'Unit_Hours' | `31`: invalid<br>`26`: invalid<br>`28`: invalid<br>`30`: invalid<br>`29`: invalid<br>`25`: invalid<br>`24`: invalid<br>`27`: invalid |
...
| `DN1_alt_Kilometerstand` | **DN1_Outdated_mileage** | Bit 62, 1b, Intel | Scale: 1.0 | `1`: outdated<br>`0`: currently received |
| `DN1_alt_Zeit` | **DN1_Obsolete_time** | Bit 63, 1b, Intel | Scale: 1.0 | `1`: outdated<br>`0`: currently received |
...
| `FI1_Geheimnis_1` | **FI1_Secret_1** | Bit 8, 8b, Intel | Scale: 1.0 | - |
...
| `RA4_Radio_Error_flag` | **RA4_Radio_Error_flag**<br>*Note: Error entry exists* | Bit 7, 1b, Intel | Scale: 1.0 | `1`: Error memory entry<br>`0`: no error memory entry |
