...
removal of the menu system in favor of cycling between nav, now playing, phone, and car info with the rocker. Nav is automatically switched to when navigation is active, and not part of the cycling when it is not. I may implement the same for phone. Car info needs proper can IDs. hell, i may even add full TP2.0 and pull measuring blocks FIS control style eventually.
